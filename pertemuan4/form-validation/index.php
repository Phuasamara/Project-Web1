    ...
    <div class="wrapper">
        ...
        <form action="" method="post" class="form">
            ...
            <div class="input-field">
                ...
                <input type="text" name="url" class="input" id="website" placeholder="Enter your full name" value="<?php if (isset($_POST['submit'])){ echo $url; } ?>">
            </div>
            <div class="input-field">
            ...
            <div class="input-field">
                ...
                <input type="password" name="cpassword" class="input" id="cpassword" placeholder="Enter your full name" value="<?php if (isset($_POST['submit'])){ echo $cpassword; } ?>">
            </div>
